...
beautiful.init("/home/cagu/.config/awesome/theme-def.lua")
...
globalkeys = gears.table.join(
	...
	awful.key({ modkey }, "e", function()
		awful.spawn.with_shell("$TERMINAL -e lf")
	end, { description = "run lf file explorer", group = "launcher" }),

	awful.key({ modkey }, "`", function()
		awful.spawn.with_shell("sh ~/.local/bin/powermenu")
...
awful.rules.rules = {
	...
	{ rule = { instance = "Firefox" }, properties = { tag = "1" } },

	{ rule = { instance = "ueberzug" }, properties = { floating = true } },

	{ rule = { instance = "polybar" }, properties = { border_width = 0 } },
}
-- }}}
...
beautiful.notification_font = "Fira Code Nerd Font 10"
...
awful.spawn.with_shell(
	'xinput set-prop "MOSART Semi. MI Mouse A1w Mouse" "Coordinate Transformation Matrix" 2.4 0 0 0 2.4 0 0 0 1'
)
